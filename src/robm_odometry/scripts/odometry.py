...
class WheelOdometry:
    ...
    def encoders_callback(self, motors_state):
        ...
        d_left  = left_pos -  self._old_left_pos # TODO
        d_right = right_pos - self._old_right_pos  # TODO
        #...  # TODO
        self._old_left_pos = left_pos
        self._old_right_pos = right_pos

        # TODO: Calcul du déplacement du robot
        ds     = self.r*(d_left + d_right)/2  # TODO
        dtheta = self.r*(d_left - d_right)/ self.L  # TODO

        # TODO: Mise à jour de la position estimée du robot
        self.x     = self.x + ds*cos(self.theta)  # TODO
        self.y     = self.y + ds*sin(self.theta)  # TODO
        ...
        msg.pose.pose.position.x  = self.x  #TODO
        msg.pose.pose.position.y  = self.y  #TODO
        msg.pose.pose.orientation = quaternion_msg_from_yaw(self.theta)  #TODO
